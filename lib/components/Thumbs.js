...
var Thumbs = function (_Component) {
    ...
    function Thumbs(props) {
        ...
        var currentPosition = -0 * null + 'px';

        var transformProp = (0, _CSSTranslate2.default)(currentPosition, props.axis);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.updateSizes = function () {
        ...
        _this3.setState({
            ...
            firstItem: showArrows ? _this3.getFirstItem(_this3.props.selectedItem) : 0,
    ...
    this.onSwipeMove = function (deltaX) {
        ...
        ['WebkitTransform', 'MozTransform', 'MsTransform', 'OTransform', 'transform', 'msTransform'].forEach(function (prop) {
            _this3.setState({ itemsListRef: _extends({}, _this3.state.itemsListRef, _defineProperty({}, '' + prop, (0, _CSSTranslate2.default)(position, _this3.props.axis))) });
